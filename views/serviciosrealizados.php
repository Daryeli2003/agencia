...
$mantenimientos = $mantenimientoModel->obtenerTodosLosMantenimientos();
?>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
       ...
       <div class="container">
            ...
            <?php if (isset($_GET['status'])): ?>
                <div class="alert alert-success">Acción completada con éxito.</div>
            <?php endif; ?>
            ...
            <?php else: ?>
                <table>
                    <thead>
                        <tr>
                            <th>ID</th><th>Fecha</th><th>Descripción</th><th>Autoriza</th><th>Acciones</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= htmlspecialchars(substr($mantenimiento['Descripcion'], 0, 30)) ?>...</td>
                            <td><?= htmlspecialchars($mantenimiento['quien_autoriza']) ?></td>
                            <td class="actions">
                                
                                <a href="<?php echo BASE_URL; ?>index.php?page=editarservicio&id=<?= $mantenimiento['id_Mantenimiento'] ?>" class="action-btn btn-primary">Editar</a>
                                
                                <form action="<?php echo BASE_URL; ?>controllers/MantenimientoController.php" method="POST" style="display: inline;">
                                    <input type="hidden" name="accion" value="eliminar">
                                    <input type="hidden" name="id_eliminar" value="<?= $mantenimiento['id_Mantenimiento'] ?>">
                                    <button type="submit" class="action-btn btn-danger" onclick="return confirm('¿Estás seguro?')">Eliminar</button>
                                </form>
                            </td>
                        </tr>
                        <?php endforeach; ?>
