...
$productos = $catalogoModelo->obtenerTodosLosProductos();
if (!$productos) {
    $productos = [];
}
?>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="contenido-crud">
            ...
            <table>
                ...
                <tbody id="tabla-catalogo-body">
                    <?php foreach ($productos as $producto): ?>
                    <tr data-id-producto="<?php echo htmlspecialchars($producto->id); ?>">
                        <td data-field="id"><?php echo htmlspecialchars($producto->id); ?></td>
                        <td>
                            <img src="<?php echo ASSETS_URL . 'assets/img/catalogo/' . htmlspecialchars($producto->imagen); ?>" alt="Imagen del producto" class="imagen-catalogo">
                        </td>
                        <td data-field="precio">$<?php echo number_format(htmlspecialchars($producto->precio), 2); ?></td>
                        <td data-field="descripcion"><?php echo htmlspecialchars($producto->descripcion); ?></td>
                        <td data-field="estado"><?php echo htmlspecialchars($producto->estado); ?></td>
                        <td data-field="fecha_publicacion"><?php echo htmlspecialchars($producto->fecha_publicacion); ?></td>
                        <td class="acciones">
                            <button class="btn-editar">Editar</button>
                            <button class="btn-eliminar" data-url="<?php echo BASE_URL; ?>controllers/catalogoController.php?action=eliminar_producto&id=<?php echo htmlspecialchars($producto->id); ?>">Eliminar</button>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                    <?php if (empty($productos)): ?>
                    <tr><td colspan="7" style="text-align:center;">No hay productos registrados en el catálogo.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
            <div class="contenedor-boton-web">
                <a href="<?php echo BASE_URL; ?>index.php?page=catalogo_pagina" target="_blank" class="btn-ir-a-web">
                    <i class="zmdi zmdi-globe"></i> Ir a la Página Web
                </a>
            </div>
        ...
        <script>
            const API_URL = "<?php echo BASE_URL; ?>controllers/catalogoController.php";
        </script>
