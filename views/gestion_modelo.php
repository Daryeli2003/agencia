    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="contenido-pagina">
            ...
            <div class="content-box">
                <h3>Añadir Nuevo Modelo</h3>
                <form action="<?php echo BASE_URL; ?>controllers/modeloController.php" method="POST" class="form-inline">
                    <input type="hidden" name="action" value="crear">
                    <input type="text" name="nombre_modelo" placeholder="Nombre del nuevo modelo" required>
                    <button type="submit" class="btn-principal">Añadir Modelo</button>
                </form>
            </div>
            ...
            <div class="content-box">
                ...
                <div class="tabla-contenedor sin-sombra">
                    <table>
                        ...
                        <tbody>
                            <?php 
                            // $listaModelos es provista por index.php
                            if ($listaModelos && $listaModelos->rowCount() > 0): 
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="acciones">
                                            <!-- Link para EDITAR -->
                                            <a href="<?php echo BASE_URL; ?>index.php?page=editar_modelo&id=<?php echo $row['Id_Modelo']; ?>" class="btn-accion btn-editar">Editar</a>
                                            <!-- Link para ELIMINAR -->
                                            <a href="<?php echo BASE_URL; ?>controllers/modeloController.php?action=eliminar&id=<?php echo $row['Id_Modelo']; ?>" class="btn-accion btn-eliminar" onclick="return confirm('¿Estás seguro? Se eliminará el modelo.');">Eliminar</a>
                                        </td>
                                    </tr>
                            <?php 
                                endwhile; 
                            ...
                            ?>
                                <tr>
                                    <td colspan="3" class="no-data">No hay modelos registrados.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
