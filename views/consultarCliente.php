...
$modelo = new UsuarioClienteCitaModel();
       ...
       <div class="contenido-crud">
            ...
            <table>
                ...
                <tbody id="tabla-clientes-body">
                    ...
                    <tr data-id-cliente="<?php echo htmlspecialchars($cliente->Id_Cliente); ?>" data-id-usuario="<?php echo htmlspecialchars($cliente->Id_Usuario); ?>">
                        <td data-field="Id_Cliente"><?php echo htmlspecialchars($cliente->Id_Cliente); ?></td>
                        <td data-field="Nombre"><?php echo htmlspecialchars($cliente->Nombre); ?></td>
                        <td data-field="Apellido"><?php echo htmlspecialchars($cliente->Apellido); ?></td>
                        <td data-field="Cedula"><?php echo htmlspecialchars($cliente->Cedula); ?></td>
                        <td data-field="Telefono"><?php echo htmlspecialchars($cliente->Telefono); ?></td>
                        <td data-field="Correo"><?php echo htmlspecialchars($cliente->Correo); ?></td>
                        <td data-field="Rif"><?php echo htmlspecialchars($cliente->Rif); ?></td>
                        <td data-field="Direccion"><?php echo htmlspecialchars($cliente->Direccion); ?></td>
                        <td class="acciones">
                            <button class="btn-editar">Editar</button>

                            <button class="btn-eliminar" data-url="<?php echo BASE_URL; ?>controllers/usuarioClienteCitaController.php?action=admin_eliminar_cliente&id=<?php echo htmlspecialchars($cliente->Id_Cliente); ?>">Eliminar</button>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                    <?php if (empty($clientes)): ?>
                    <tr><td colspan="9" style="text-align:center;">No hay clientes registrados.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
        ...
        <script>
            const API_URL = "<?php echo BASE_URL; ?>controllers/usuarioClienteCitaController.php";
        </script>
