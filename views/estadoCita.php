...
$citas = $modelo->obtenerTodasLasCitas();
?>
<!DOCTYPE html>
<html lang="es">
<head>
        ...
        <div class="contenido-crud">
            ...
            <table>
                ...
                <tbody id="tabla-citas-body">
                    ...
                    <tr data-id-cita="<?php echo htmlspecialchars($cita->Id_Citas); ?>">
                        <td data-field="Id_Citas"><?php echo htmlspecialchars($cita->Id_Citas); ?></td>
                        <td data-field="NombreCliente"><?php echo htmlspecialchars($cita->Nombre); ?></td>
                        <td data-field="ApellidoCliente"><?php echo htmlspecialchars($cita->Apellido); ?></td>
                        <td data-field="CedulaCliente"><?php echo htmlspecialchars($cita->Cedula); ?></td>
                        <td data-field="Fecha"><?php echo htmlspecialchars($cita->Fecha); ?></td>
                        <td data-field="Hora"><?php echo htmlspecialchars($cita->Hora); ?></td>
                        <td data-field="Estado"><?php echo htmlspecialchars($cita->Estado); ?></td>
                        <td class="acciones">
                            <button class="btn-editar">Editar</button>

                            <button class="btn-eliminar" data-url="<?php echo BASE_URL; ?>controllers/usuarioClienteCitaController.php?action=admin_eliminar_cita&id=<?php echo htmlspecialchars($cita->Id_Citas); ?>">Eliminar</button>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                    
                    <?php if (empty($citas)): ?>
                    <tr><td colspan="8" style="text-align:center;">No hay citas registradas.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
