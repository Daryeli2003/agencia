            ...
            <form action="<?php echo BASE_URL; ?>controllers/MantenimientoController.php" method="post">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="id_Mantenimiento" name="id_Mantenimiento" value="<?= $_SESSION['form_data']['id_Mantenimiento'] ?? '' ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="Fecha">Fecha</label>
                        <input type="date" id="Fecha" name="Fecha" value="<?= $_SESSION['form_data']['Fecha'] ?? '' ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="Descripcion">Descripción</label>
                        <textarea id="Descripcion" name="Descripcion" required><?= $_SESSION['form_data']['Descripcion'] ?? '' ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="quien_autoriza">Quién autoriza</label>
                        <input type="text" id="quien_autoriza" name="quien_autoriza" value="<?= $_SESSION['form_data']['quien_autoriza'] ?? '' ?>" required>
                    </div>
                </div>
