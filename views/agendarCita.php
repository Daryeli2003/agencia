...
<div class="navbar-lateral full-reset">
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
      ...
      <form id="formularioCita" action="<?php echo BASE_URL; ?>controllers/usuarioClienteCitaController.php" method="POST">
       
        <?php 
            if (isset($_GET['error'])) {
                $mensaje = 'Ocurrió un error inesperado al procesar su solicitud.';
                if ($_GET['error'] == 'faltan_datos_cita') {
                    $mensaje = 'Por favor, complete la fecha y hora de la cita.';
                } elseif ($_GET['error'] == 'sesion_expirada') {
                     $mensaje = 'Los datos del cliente se han perdido. Por favor, inicie el proceso de registro de nuevo.';
                }
        ...
        <button type="submit" name="action" value="registrar_paso2_cita">Finalizar Solicitud</button>
        </form>
