    ...
    <div class="content-page-container full-reset custom-scroll-containers">
      ...
      <form id="formularioCita" action="<?php echo BASE_URL; ?>controllers/usuarioClienteCitaController.php" method="POST">
        ...
        <?php 
            if (isset($_GET['error'])) {
                ...
                if ($_GET['error'] == 'faltan_datos') {
                    ...
                    $mensaje = 'Error al guardar los datos. Verifique que la Cédula o el Correo no estén ya registrados.';
                }
        ...
        <fieldset>
         ...
         <button type="submit" name="action" value="registrar_paso1_cliente">Siguiente: Agendar Cita</button>
        </form>
