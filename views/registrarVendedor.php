...
<div class="navbar-lateral full-reset">
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
      ...
      <form id="formularioCita" action="<?php echo BASE_URL; ?>controllers/vendedorController.php" method="POST">
       
        <?php 
            if (isset($_GET['error'])) {
                $mensaje = 'Ocurrió un error inesperado al procesar su solicitud.';
                if ($_GET['error'] == 'faltan_datos') {
                    $mensaje = 'Por favor, complete Nombre y Cédula, son obligatorios.';
                } elseif ($_GET['error'] == 'db_error') {
                    $mensaje = 'Error al guardar los datos. Verifique que la Cédula o el RIF no estén ya registrados.';
                }
        ...
        <fieldset>
            ...
            <div class="campo-checkbox">
                <label>
                    <input type="checkbox" name="Copia_Llaves" value="1"> Copia de Llaves
                </label>
            </div>
            <div class="campo-checkbox">
                <label>
                    <input type="checkbox" name="Garantia_Vehiculo" value="1"> Garantía del Vehículo
                </label>
            </div>
            <div class="campo-checkbox">
                <label>
                    <input type="checkbox" name="Certificado_Garantia" value="1"> Certificado de Garantía
                </label>
            </div>
            <div class="campo-checkbox">
                <label>
                    <input type="checkbox" name="Manual_VehiculoGarantia" value="1"> Manual del Vehículo y Garantía
                </label>
            </div>
        </fieldset>

         <button type="submit" name="action" value="registrar_vendedor">Registrar Vendedor</button>
        </form>
