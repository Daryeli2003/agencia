     ...
     <div class="contenido-crud">
            ...
            <?php 
                if (isset($_GET['status']) && $_GET['status'] == 'success') {
                    echo '<div class="success-msg">Proveedor registrado correctamente.</div>';
                }
            ?>
            ...
            <table>
                ...
                <tbody id="tabla-proveedores-body">
                    ...
                    <tr data-id-proveedor="<?php echo htmlspecialchars($proveedor->Id_Proveedor); ?>">
                        <td data-field="Id_Proveedor"><?php echo htmlspecialchars($proveedor->Id_Proveedor); ?></td>
                        <td data-field="Nombre"><?php echo htmlspecialchars($proveedor->Nombre); ?></td>
                        <td data-field="Apellido"><?php echo htmlspecialchars($proveedor->Apellido); ?></td>
                        <td data-field="Direccion"><?php echo htmlspecialchars($proveedor->Direccion); ?></td>
                        <td data-field="Cedula"><?php echo htmlspecialchars($proveedor->Cedula); ?></td>
                        <td data-field="Telefono"><?php echo htmlspecialchars($proveedor->Telefono); ?></td>
                        <td data-field="Tipo"><?php echo htmlspecialchars($proveedor->Tipo); ?></td>
                        <td class="acciones">
                            <button class="btn-editar">Editar</button>
                            <button class="btn-eliminar" data-url="<?php echo BASE_URL; ?>controllers/proovedorController.php?action=admin_eliminar_proveedor&id=<?php echo htmlspecialchars($proveedor->Id_Proveedor); ?>">Eliminar</button>
                        </td>
                    </tr>
                    <?php endforeach; ?>
        ...
        <script>
            const API_URL = "<?php echo BASE_URL; ?>controllers/proveedorController.php";
        </script>
