...
if (isset($_GET['id'])) {
    ...
    $marca = $marcaModel->leerUno($id_marca);
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="content-box">
                ...
                ?>
                    <form action="<?php echo BASE_URL; ?>controllers/marcaController.php" method="POST" class="form-inline">
                        ...
                        <input type="text" id="nombre" name="nombre" value="<?php echo htmlspecialchars($marca['Nombre']); ?>" required>
                        
                        <button type="submit" class="btn-principal">Actualizar Marca</button>
                        <a href="<?php echo BASE_URL; ?>index.php?page=gestion_marcas" class="btn-secundario">Cancelar</a>
                    </form>
                <?php else: ?>
                    <p class="no-data">No se pudo cargar la información de la marca para editar.</p>
                <?php endif; ?>
            </div>
        </div>
