$(document).ready(function(){
    ...
    $('.search-book-button').click(function(e){
        ...
        swal({
           title: "¿Qué vehículo estás buscando?",
           text: "Por favor escribe la placa del vehículo",
           type: "input",   
           showCancelButton: true,
           closeOnConfirm: false,
           animation: "slide-from-top",
           ...
           inputPlaceholder: "Escribe aquí la placa del vehículo" }, 
      function(inputValue){
           if (inputValue === false) return false;  

           if (inputValue === "") {
               swal.showInputError("Debes escribir la placa del vehículo");     
               return false;   
           } 
